...
## `Install/Delete mydumper`

Установка или удаление `mydumper` из официального репозитория проекта. При удалении меню удаляет пакет, apt-репозиторий и ключ репозитория.
